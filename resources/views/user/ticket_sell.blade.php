                ...
                <div class="container">
					 <div class="row">
						...
						<div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <form class="edit-profile" method="post" action="{{ route('sell.userticket', $tickets->id) }}">
               			@csrf
						   <input type="hidden" name="id" value="{{ $tickets->id }}">
								...
								<h2 class="title-head">Ticket  <span>Information</span></h2>
												...
												<div class="form-group row">
													...
													<div class="col-12 col-sm-9 col-md-9 col-lg-8">
														<input style="border-radius: 15px;" class="form-control" type="number" value="{{ $tickets->ticket_price }}" name="ticket_price">
														
													</div>
												</div>

                                                <input style="border-radius: 15px;" class="form-control" type="hidden" value="2" name="ticket_remark">
												...
												<div class="">
													<div class="row">
														...
														<div class="col-12 col-sm-9 col-md-9 col-lg-">
															<button style="border-radius: 15px;" type="submit" class="btn">Sell</button>
