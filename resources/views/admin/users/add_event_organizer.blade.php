...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Add New Event Organizer </h4>
            
            <form method="post" action="{{ route('admin.organizer.add') }}">
                @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="username" type="text" class="form-control" id="example-text-input" required>
                </div>
            </div>
            <!-- end row -->
...
<input type="submit" class="btn btn-info waves-effect waves-light" value="Insert New Event Organizer">
            </form>
