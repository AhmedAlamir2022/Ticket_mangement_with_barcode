...
<img class="rounded-circle avatar-xl" src="{{ asset($tickets->ticket_image) }}" alt="Card image cap">
            ...
            <div class="card-body">
                ...
                <hr>
                <h4 class="card-title">Ticket Price : {{ $tickets->ticket_price }} KWD</h4>
                <hr>
                ...
                <hr>
                <h4 class="card-title">Ticket Duration : {{ $tickets->ticket_duration }} h</h4>
                <hr>
                ...
                <hr> 
                <a href="{{ route('print.ticket1',$tickets->id) }}" class="btn btn-danger btn-rounded waves-effect waves-light" > Print Ticket Information</a>
