...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{ route('store.event.category1') }}" enctype="multipart/form-data">
                @csrf
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Blog Details </label>
                <div class="col-sm-10">
